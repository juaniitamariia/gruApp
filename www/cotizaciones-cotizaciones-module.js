...
module.exports = ".precio {\n  color: red;\n  font-weight: 800; }\n\n.nombre {\n  font-weight: 800; }\n\n.btn-aceptar {\n  --background: rgb(30, 219, 140);\n  --color: white;\n  font-size: 15px;\n  width: 50px; }\n\n.btn-declinar {\n  --background:rgb(219, 61, 61);\n  --color: white;\n  font-size: 15px;\n  width: 50px; }\n\n.espacio {\n  left: 0;\n  right: 0;\n  margin-left: auto;\n  margin-right: auto;\n  height: 100vh; }\n\n.titulo {\n  font-size: 12px;\n  margin-bottom: 20px;\n  margin-top: 20px; }\n\n.explicacion {\n  left: 0;\n  right: 0;\n  margin-left: auto;\n  margin-right: auto;\n  margin-bottom: 0px;\n  font-size: 10px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var CotizacionesPage = /** @class */ (function () {
    function CotizacionesPage(location, provider) {
    ...
    CotizacionesPage.prototype.removeCotizaciones = function (selectedQuotes) {
        ...
        console.log(index);
        console.log('enter');
        parse__WEBPACK_IMPORTED_MODULE_4__["Cloud"].run('deleteQuotes', { quotesID: selectedQuotes.objectId }).then(function (result) {
    ...
    CotizacionesPage.prototype.getQuotes = function () {
        var _this = this;
        parse__WEBPACK_IMPORTED_MODULE_4__["Cloud"].run('getUsersQuotes', { serviceID: this.provider.serviceId }).then(function (result) {
            if (result.length === 0) {
    ...
    CotizacionesPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"], _gruprovider_service__WEBPACK_IMPORTED_MODULE_3__["GruproviderService"]])
    ], CotizacionesPage);
