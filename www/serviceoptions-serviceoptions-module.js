...
var ServiceoptionsPage = /** @class */ (function () {
    ...
    ServiceoptionsPage.prototype.goToLocation = function () {
    ...
    ServiceoptionsPage.prototype.makePayment = function () {
        ...
        if (this.provider.card == null) {
            ...
            parse__WEBPACK_IMPORTED_MODULE_5__["Cloud"].run('purchase', {
                ...
                console.log(result);
                parse__WEBPACK_IMPORTED_MODULE_5__["Cloud"].run('createServiceRequest', {
                    ...
                    dateString: moment__WEBPACK_IMPORTED_MODULE_6__(new Date()).format('M/D/YYYY, h:mm a')
                }).then(function (result) {
                    console.log(result);
    ...
    ServiceoptionsPage.prototype.Listo = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
